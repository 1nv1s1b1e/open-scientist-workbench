            ...
            >
              ...
              >
                ...
                <span className="min-w-0 flex-1">
                  <span className="flex items-center gap-2 text-[10px] font-mono uppercase tracking-[0.08em] text-[var(--color-text-muted)]">
                    <Icon className={`h-3.5 w-3.5 ${status.color}`} />
                    <span className={status.color}>{status.label}</span>
                    <span>·</span>
                    <span className="truncate">{item.evidenceId}</span>
                  </span>
                  <span className="mt-1 block text-[13px] leading-5 text-[var(--color-body)]">
                    {item.claim}
                  </span>
                </span>
                <ChevronDown
                ...
                {isOpen && (
                  ...
                  >
                    <div className="ml-8 mr-4 mb-3 rounded-lg border border-white/[0.07] bg-black/20 p-3 text-xs leading-5 text-[var(--color-text-muted)]">
                      ...
                      {item.provenance && (
                        <div className="mt-2 rounded-md border border-cyan-200/10 bg-cyan-200/[0.035] p-2 font-mono text-[10px] leading-5 text-cyan-100/60">
